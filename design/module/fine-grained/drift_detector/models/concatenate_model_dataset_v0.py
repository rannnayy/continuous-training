...
if __name__ == '__main__':
    ...
    if not args.datasets or len(dataset_paths) <= 1:
        print("ERROR: Invalid argument. \n(sample: python concatenate_model_dataset_v0.py -datasets ./dataset/nvme1n1/*.per_10k/profile_v1.feat_v6.readonly.dataset/classification_nn/algo_4_ks_test_thpt/100_dataset/normal/drift_data_v0.csv ./dataset/nvme1n1/*.per_10k/profile_v1.feat_v6.readonly.dataset/classification_nn/algo_8_js_thpt/100_dataset/normal/drift_data_v0.csv'")
        exit()
    ...
    file_path = os.path.join(new_path, 'drift_data_v0.csv')
    ...
    stats_path = os.path.join(new_path, 'drift_data_v0.stats')
